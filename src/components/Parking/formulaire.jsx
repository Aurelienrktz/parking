...
function Formulaire({ AjouterVoiture, numero, voitures }) {
  ...
  function handleSubmit(e) {
    ...
    if (voiture.nom == "") {
      alert("Veuilez entrer un nom");
    } else if (voiture.immatr == "") {
      alert("Veuilez entrer une immatriculation");
    } else {
  ...
  return (
    <form
      id="ajout"
      name="ajout"
      className={s.container2}
      onSubmit={handleSubmit}
    >
      <h1>Enregistrement Parking N°{numero}</h1>
      <label htmlFor="nom" id="label1">
        Nom du propriétaire :
      </label>
      <input
        id="nom"
      ...
      />
      <label htmlFor="immatriculation" id="label2">
